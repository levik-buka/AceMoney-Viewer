// AceMoney Viewer.cpp : Defines the class behaviors for the application.
//
...
BOOL CViewerApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		...
		RUNTIME_CLASS(CViewerChartView));
	...
	//((CMainFrame*)m_pMainWnd)->m_wndDlgBar.GetDlgItem (IDC_BUTTON_TEST)->EnableWindow ();
	return TRUE;
}
...
CRecentFileList* CViewerApp::GetRecentFileList()
{
